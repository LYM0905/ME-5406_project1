...
class Environment(tk.Tk, object):
    ...
    def build_4x4_environment(self):
        ...
        # Obstacle type 7 - hole at icelake
        img_obstacle1 = Image.open("images/hole.png")
    ...
    def build_10x10_environment(self):
        ...
        self.obstacle2 = self.canvas_widget.create_image(pixels * 1, pixels * 1, anchor='nw',
                                                         image=self.obstacle1_object)
        self.obstacle3 = self.canvas_widget.create_image(pixels * 3, pixels * 2, anchor='nw',
                                                         image=self.obstacle1_object)
        ...
        self.obstacle7 = self.canvas_widget.create_image(pixels * 6, pixels * 7, anchor='nw',
                                                         image=self.obstacle1_object)
        self.obstacle8 = self.canvas_widget.create_image(pixels * 3, pixels * 7, anchor='nw',
                                                         image=self.obstacle1_object)
        ...
        self.obstacle14 = self.canvas_widget.create_image(pixels * 1, pixels * 6, anchor='nw',
                                                          image=self.obstacle1_object)
        self.obstacle15 = self.canvas_widget.create_image(pixels * 1, pixels * 8, anchor='nw',
                                                          image=self.obstacle1_object)
        ...
        self.obstacle18 = self.canvas_widget.create_image(pixels * 6, pixels * 2, anchor='nw',
                                                          image=self.obstacle1_object)
        self.obstacle19 = self.canvas_widget.create_image(pixels * 8, pixels * 1, anchor='nw',
                                                          image=self.obstacle1_object)
        ...
        self.obstacle21 = self.canvas_widget.create_image(pixels * 5, pixels * 5, anchor='nw',
                                                          image=self.obstacle1_object)
        self.obstacle22 = self.canvas_widget.create_image(pixels * 8, pixels * 8, anchor='nw',
                                                          image=self.obstacle1_object)
    ...
    def step(self, action):
        ...
        elif next_state == state:  # Determine whether it is out of bounds (or not moved)
            reward = -0.002  # Give an out-of-bounds penalty
            done = False  
